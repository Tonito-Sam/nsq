  ...
  return (
    <div className="relative">
      <Button
        ...
        className={`hover:bg-red-50 dark:hover:bg-red-950 ${currentReaction ? currentIcon.color : 'text-gray-500'} flex items-center space-x-1.5 px-2 py-1 rounded-lg transition-all duration-200 hover:scale-105`}
      >
        <CurrentIcon className={`h-4 w-4 ${currentReaction ? 'fill-current' : ''}`} />
          ...
          {Object.entries(reactionConfig).map(([type, config]) => {
            ...
            return (
              <Button
                ...
                className={`hover:bg-gray-100 dark:hover:bg-gray-700 ${config.color} relative group`}
