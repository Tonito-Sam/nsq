    ...
    <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-800">
      <div className="flex items-center space-x-1 md:space-x-2 flex-wrap">
        ...
        <Button
          ...
          className="flex items-center space-x-1 text-gray-500 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-1 py-0.5 md:px-1.5 md:py-0.5 rounded-lg transition-all duration-200"
        >
          <MessageCircle className="h-3.5 w-3.5 md:h-4 md:w-4" />
          <span className="text-xs md:text-sm font-medium ml-0.5">{currentComments}</span>
        </Button>
        ...
        <Button
          ...
          size="sm"
          onClick={onRepost}
          className={`flex items-center space-x-1 px-1 py-0.5 md:px-1.5 md:py-0.5 rounded-lg transition-all duration-200 ${
        ...
        >
          ...
          <span className="text-xs md:text-sm font-medium ml-0.5">{currentReposts}</span>
        </Button>
        ...
        <Button
          ...
          size="sm"
          onClick={onShare}
          className="flex items-center space-x-1 text-gray-500 hover:text-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/20 px-1 py-0.5 md:px-1.5 md:py-0.5 rounded-lg transition-all duration-200"
        >
          <Share2 className="h-3.5 w-3.5 md:h-4 md:w-4" />
          <span className="text-xs md:text-sm font-medium ml-0.5">{shares}</span>
        </Button>
        ...
        <div className="flex items-center">
          <Button
            variant="ghost"
            size="sm"
            className="flex items-center space-x-1 text-gray-500 hover:text-gray-700 px-1 py-0.5 md:px-1.5 md:py-0.5 rounded-lg transition-all duration-200"
          ...
          >
            ...
            <span className="text-xs md:text-sm font-medium ml-0.5">{viewsCount !== null ? viewsCount : 0}</span>
          </Button>
          {postId && (
