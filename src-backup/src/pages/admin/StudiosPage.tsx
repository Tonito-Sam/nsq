              ...
              {showStep === 1 && (
                <form onSubmit={e => { e.preventDefault(); setShowStep(2); }} className="space-y-4">
                  ...
                  <div>
                    ...
                    <select name="schedule_pattern" value={form.schedule_pattern || ''} onChange={handleFormChange} className="mb-2 border rounded px-2 py-1 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
                  ...
                  <div>
                    ...
                    <select name="category" value={form.category || ''} onChange={handleFormChange} className="mb-2 border rounded px-2 py-1 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
                        <option value="">None</option>
                        {/* Use canonical category list */}
                        {[
                          "Fanalysis",
                  ...
                  <div className="flex gap-2">
                    <div>
                      ...
                      <input type="time" name="time_slot_start" value={form.time_slot_start || (form.scheduled_time ? form.scheduled_time.substring(11,16) : '')} onChange={handleFormChange} className="w-full" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium mb-1">Time Slot End</label>
                      <input type="time" name="time_slot_end" value={form.time_slot_end || (form.end_time ? form.end_time.substring(11,16) : '')} onChange={handleFormChange} className="w-full" />
                    </div>
                  </div>
                  <div className="mt-2">
